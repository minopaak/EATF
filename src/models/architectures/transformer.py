...
class Transformer(nn.Module):
    """Vanilla Transformer (Vaswani et al., NeurIPS 2017), forecasting 경로.

    Time-Series-Library(thuml; MM-TSFlib 경유)의 models/Transformer.py 이식.
    우리 forward 계약(model(x_enc, None, None, None))에 맞춰 디코더 입력을 내부 구성.
    """
